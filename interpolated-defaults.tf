locals {
  ...
  ampls_scope_name            = var.existing_private_link_scope_name == null && var.existing_private_link_scope_rg_name == null ? var.ampls_pe_subnet_id != null ? azurerm_monitor_private_link_scope.this[0].name : null : var.existing_private_link_scope_name
  ...
  deploy_private_connectivity = (var.existing_private_link_scope_name != null && var.existing_private_link_scope_rg_name != null) || var.ampls_pe_subnet_id != null
}
