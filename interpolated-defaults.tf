locals {
  ...
  ampls_scope_rg_name           = var.private_connectivity == null ? null : var.private_connectivity.existing_scope ? var.private_connectivity.scope_rg_name : var.resource_group.name
